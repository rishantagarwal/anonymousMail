...
class PlancakeEmailParser {
    ...
    public function getSubject()
    {
        ...
        if ($this->isImapExtensionAvailable) {
            ...
            $ret = utf8_encode(iconv_mime_decode($this->rawFields['subject'],2));
        }
    ...
    public function getTo()
    {
        ...
        return explode(',', $this->rawFields['to'])[0];
    }
     ...
     public function getFrom()
    {
        ...
        return explode(',', $this->rawFields['from'])[0];
    }
...
$url = 'https://mailing-bindasrishant-1.c9.io/';
$data = array(
...
//syslog(LOG_INFO,$context);
syslog(LOG_INFO,$result);
syslog(LOG_INFO, "subject: " . $emailParser->getSubject() . "\r\n");
syslog(LOG_INFO,"body: " . $emailParser->getPlainBody() . "\r\n");
syslog(LOG_INFO,"to: " . $emailParser->getTo() . "\r\n");
syslog(LOG_INFO,"from: " . $emailParser->getFrom() . "\r\n");
